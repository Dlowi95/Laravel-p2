...
<div class="ibox variant-box">
    <div class="ibox-title">
        ...
        <div class="description">Cho phép bạn bán các phiên bản khác nhau của sản phẩm, ví dụ: : quần, áo thì có các <strong class="text-danger text-uppercase">màu sắc</strong> và <strong class="text-danger text-uppercase">size</strong> số khác nhau. Mỗi phiên bản sẽ là 1 dòng trong mục danh sách phiên bản phía dưới</div>
    </div>
