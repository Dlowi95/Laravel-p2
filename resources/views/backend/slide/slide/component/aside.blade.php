                ...
                <div class="slide-setting">
                    <div class="setting-item">
                        <div class="uk-flex uk-flex-middle">
                            <span data-toggle="tooltip" data-placement="top" data-original-title="Tooltip on top" class="setting-text">Chiều rộng: <i class="fa fa-info-circle" aria-hidden="true"></i></span>
                            <div class="setting-value">
                                ...
                                >
                                <span class="px text-bold">px</span>
                            </div>
                        </div>
                    </div>
                    <div class="setting-item">
        ...
        <div class="setting-item">
            <div class="uk-flex uk-flex-middle">
                ...
                <div class="setting-value">
                    ...
                    >
                    <span class="px text-bold">ms</span>
                </div>
            </div>
        </div>
        <div class="setting-item">
